...
var useCombobox = createHook(
  function useCombobox2(_a) {
    ...
    const canAutoSelectRef = (0, import_react9.useRef)(false);
    const composingRef = (0, import_react9.useRef)(false);
    const autoSelect = store.useState(
      (state) => state.virtualFocus && autoSelectProp
    );
    const inline = autoComplete === "inline" || autoComplete === "both";
    const [canInline, setCanInline] = (0, import_react9.useState)(inline);
    useUpdateLayoutEffect(() => {
      if (!inline) return;
      setCanInline(true);
    }, [inline]);
    const storeValue = store.useState("value");
    const prevSelectedValueRef = (0, import_react9.useRef)();
    ...
    const scrollingElementRef = (0, import_react9.useRef)(null);
    const getAutoSelectIdProp = useEvent(getAutoSelectId);
    const autoSelectIdRef = (0, import_react9.useRef)(null);
    (0, import_react9.useEffect)(() => {
      if (!open) return;
...
var TagName9 = "button";
var children = (0, import_jsx_runtime4.jsx)(
  "svg",
  {
    "aria-hidden": "true",
    display: "block",
    ...
    width: "1em",
    pointerEvents: "none",
    children: (0, import_jsx_runtime4.jsx)("polyline", { points: "4,6 8,10 12,6" })
  }
);
...
var CheckboxCheckedContext = (0, import_react14.createContext)(false);

// node_modules/@ariakit/react-core/esm/__chunks/5JCRYSSV.js
var import_react15 = __toESM(require_react(), 1);
var import_jsx_runtime5 = __toESM(require_jsx_runtime(), 1);
var TagName10 = "span";
var checkmark = (0, import_jsx_runtime5.jsx)(
  "svg",
  {
    display: "block",
    fill: "none",
    ...
    height: "1em",
    width: "1em",
    children: (0, import_jsx_runtime5.jsx)("polyline", { points: "4,8 7,12 12,4" })
  }
);
...
var useCheckboxCheck = createHook(
  function useCheckboxCheck2(_a) {
    ...
    const context = (0, import_react15.useContext)(CheckboxCheckedContext);
...
var useComboboxItemCheck = createHook(function useComboboxItemCheck2(_a) {
  var _b = _a, { store, checked } = _b, props = __objRest(_b, ["store", "checked"]);
  const context = (0, import_react16.useContext)(ComboboxItemCheckedContext);
  checked = checked != null ? checked : context;
...
function splitValue(itemValue, userValue) {
  ...
  const parts = [];
  const span = (value, autocomplete = false) => (0, import_jsx_runtime6.jsx)(
    "span",
    {
...
var useComboboxItemValue = createHook(function useComboboxItemValue2(_a) {
  ...
  const children3 = (0, import_react17.useMemo)(() => {
    if (!itemValue) return;
...
var useCompositeItem = createHook(
  function useCompositeItem2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime7.jsx)(CompositeItemContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    props = __spreadProps(__spreadValues({
      id,
...
var useComboboxItem = createHook(
  function useComboboxItem2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime8.jsx)(ComboboxItemValueContext.Provider, { value, children: (0, import_jsx_runtime8.jsx)(ComboboxItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }) }),
      [value, selected]
    );
...
var useDisclosureContent = createHook(function useDisclosureContent2(_a) {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime9.jsx)(DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
...
var DisclosureContent = forwardRef2(function DisclosureContent2(_a) {
  ...
  return (0, import_jsx_runtime9.jsx)(DisclosureContentImpl, __spreadValues({}, props));
});
...
var useComboboxList = createHook(
  function useComboboxList2(_a) {
    ...
    const [hasListboxInside, setHasListboxInside] = (0, import_react23.useState)(false);
    const contentElement = store.useState("contentElement");
    useSafeLayoutEffect(() => {
      if (!mounted) return;
      const element = ref.current;
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime10.jsx)(ComboboxScopedContextProvider, { value: store, children: (0, import_jsx_runtime10.jsx)(ComboboxListRoleContext.Provider, { value: role, children: element }) }),
      [store, role]
    );
...
var Role = forwardRef2(
  ...
  function Role2(props) {
    return createElement(TagName19, props);
  }
);
Object.assign(
  Role,
...
function DialogBackdrop({
  ...
  if ((0, import_react24.isValidElement)(backdrop)) {
    return (0, import_jsx_runtime11.jsx)(Role, __spreadProps(__spreadValues({}, props), { render: backdrop }));
  }
  const Component = typeof backdrop !== "boolean" ? backdrop : "div";
  return (0, import_jsx_runtime11.jsx)(Role, __spreadProps(__spreadValues({}, props), { render: (0, import_jsx_runtime11.jsx)(Component, {}) }));
}
...
var NestedDialogsContext = (0, import_react27.createContext)({});
function useNestedDialogs(store) {
  const context = (0, import_react27.useContext)(NestedDialogsContext);
  const [dialogs, setDialogs] = (0, import_react27.useState)([]);
  const add = (0, import_react27.useCallback)(
    (dialog) => {
      var _a;
  ...
  const providerValue = (0, import_react27.useMemo)(() => ({ store, add }), [store, add]);
  const wrapElement = (0, import_react27.useCallback)(
    (element) => (0, import_jsx_runtime12.jsx)(NestedDialogsContext.Provider, { value: providerValue, children: element }),
    [providerValue]
  );
...
function usePreviousMouseDownRef(enabled) {
  const previousMouseDownRef = (0, import_react28.useRef)();
...
function useEventOutside({
  ...
  const focusedRef = (0, import_react29.useRef)(false);
  useSafeLayoutEffect(() => {
    if (!open) return;
    if (!domReady) return;
...
var HeadingContext = (0, import_react30.createContext)(0);

// node_modules/@ariakit/react-core/esm/__chunks/5M6RIVE2.js
var import_react31 = __toESM(require_react(), 1);
var import_jsx_runtime14 = __toESM(require_jsx_runtime(), 1);
function HeadingLevel({ level, children: children3 }) {
  const contextLevel = (0, import_react31.useContext)(HeadingContext);
  const nextLevel = Math.max(
    Math.min(level || contextLevel + 1, 6),
    1
  );
  return (0, import_jsx_runtime14.jsx)(HeadingContext.Provider, { value: nextLevel, children: children3 });
}
...
var PortalContext = (0, import_react32.createContext)(null);
...
var usePortal = createHook(function usePortal2(_a) {
  ...
  const context = (0, import_react33.useContext)(PortalContext);
  const [portalNode, setPortalNode] = (0, import_react33.useState)(null);
  const [anchorPortalNode, setAnchorPortalNode] = (0, import_react33.useState)(
    null
  );
  const outerBeforeRef = (0, import_react33.useRef)(null);
  const innerBeforeRef = (0, import_react33.useRef)(null);
  const innerAfterRef = (0, import_react33.useRef)(null);
  const outerAfterRef = (0, import_react33.useRef)(null);
  useSafeLayoutEffect(() => {
    const element = ref.current;
    if (!element || !portal) {
      setPortalNode(null);
  ...
  props = useWrapElement(
    ...
    (element) => {
      ...
      (0, import_jsx_runtime15.jsx)(PortalContext.Provider, { value: portalNode || context, children: element });
      ...
      element = (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
        preserveTabOrder && portalNode && (0, import_jsx_runtime15.jsx)(
          FocusTrap,
          {
            ref: innerBeforeRef,
      ...
      let preserveTabOrderElement = (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
        preserveTabOrder && portalNode && (0, import_jsx_runtime15.jsx)(
          FocusTrap,
          {
            ref: outerBeforeRef,
        ...
        (0, import_jsx_runtime15.jsx)("span", { "aria-owns": portalNode == null ? void 0 : portalNode.id, style: { position: "fixed" } }),
        preserveTabOrder && portalNode && (0, import_jsx_runtime15.jsx)(
          FocusTrap,
          {
            ref: outerAfterRef,
...
var useDialog = createHook(function useDialog2(_a) {
  ...
  const [autoFocusEnabled, setAutoFocusEnabled] = (0, import_react34.useState)(false);
  (0, import_react34.useEffect)(() => {
    if (!open) return;
  ...
  const [hasOpened, setHasOpened] = (0, import_react34.useState)(false);
  (0, import_react34.useEffect)(() => {
    if (!open) return;
    setHasOpened(true);
    return () => setHasOpened(false);
  }, [open]);
  const focusOnHide = (0, import_react34.useCallback)(
    (dialog, retry = true) => {
      const { disclosureElement } = store.getState();
  ...
  const focusedOnHideRef = (0, import_react34.useRef)(false);
  useSafeLayoutEffect(() => {
    if (open) return;
    if (!hasOpened) return;
  ...
  const [headingId, setHeadingId] = (0, import_react34.useState)();
  const [descriptionId, setDescriptionId] = (0, import_react34.useState)();
  props = useWrapElement(
    props,
...
function createDialogComponent(Component, useProviderContext = useDialogProviderContext) {
  return forwardRef2(function DialogComponent(props) {
    ...
    return (0, import_jsx_runtime16.jsx)(Component, __spreadValues({}, props));
  });
}
...
var usePopover = createHook(
  function usePopover2(_a) {
    ...
    const defaultArrowElementRef = (0, import_react35.useRef)(null);
    const [positioned, setPositioned] = (0, import_react35.useState)(false);
    const { portalRef, domReady } = usePortalRef(portal, props.portalRef);
...
var useComboboxPopover = createHook(
  function useComboboxPopover2(_a) {
    ...
    const hiddenByClickOutsideRef = (0, import_react36.useRef)(false);
...
var children2 = (0, import_jsx_runtime18.jsxs)(
  "svg",
  {
    "aria-hidden": "true",
    display: "block",
    ...
    pointerEvents: "none",
    children: [
      (0, import_jsx_runtime18.jsx)("line", { x1: "5", y1: "5", x2: "11", y2: "11" }),
      (0, import_jsx_runtime18.jsx)("line", { x1: "5", y1: "11", x2: "11", y2: "5" })
    ]
  }
);
  ...
  function useComboboxCancel2(_a) {
    ...
    props = useWrapElement(
      ...
      (element) => {
        ...
        if (empty) return (0, import_jsx_runtime18.jsx)(import_react37.Fragment, {});
        return element;
      },
      [hideWhenEmpty, empty]
    );
...
var useGroup = createHook(
  function useGroup2(props) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime19.jsx)(GroupLabelContext.Provider, { value: setLabelId, children: element }),
      []
    );
    props = __spreadValues({
      role: "group",
...
use-sync-external-store/cjs/use-sync-external-store-shim.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5RMC4PLS.js.map
