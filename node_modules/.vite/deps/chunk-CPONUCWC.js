import {
  ...
  taxRegionLoader
} from "./chunk-VZ5PZL4E.js";
import {
  isFetchError
} from "./chunk-KVYUPD43.js";
import {
  FeatureFlagProvider
} from "./chunk-T7OF2W4H.js";
import {
  useReturnReasons
} from "./chunk-F3GM3UEA.js";
import {
  I18n
} from "./chunk-FQNE4ZAS.js";
import {
  ProgressBar
...
import {
  we
} from "./chunk-2DXGTPQW.js";
import {
  t
} from "./chunk-MPXR7HT5.js";
import {
  languages
} from "./chunk-3LQQT5NQ.js";
import {
  formatDistance
} from "./chunk-27OTIEV6.js";
import {
  FilePreview
} from "./chunk-S4HN2HPG.js";
import {
  Form
...
import {
  useLogout
} from "./chunk-2OXNHFEZ.js";
import {
  useTaxRegions
} from "./chunk-5IBQGJLF.js";
import {
  useProductTypes
} from "./chunk-YAWV2GEU.js";
import {
  useApiKeys
} from "./chunk-VOONU5MK.js";
import {
  useShippingProfiles
} from "./chunk-J3LWFF2Z.js";
import {
  useMe,
  useUsers
} from "./chunk-7XAJZFZJ.js";
import {
  usePriceLists
} from "./chunk-LH7VBQ45.js";
import {
  useCustomerGroups,
  useCustomers
...
// node_modules/@medusajs/dashboard/dist/chunk-SJFXY376.mjs
...
var Providers = ({ api, children }) => {
  return (0, import_jsx_runtime3.jsx)(TooltipProvider, { children: (0, import_jsx_runtime3.jsx)(ExtensionProvider, { api, children: (0, import_jsx_runtime3.jsx)(HelmetProvider, { children: (0, import_jsx_runtime3.jsx)(QueryClientProvider, { client: queryClient, children: (0, import_jsx_runtime3.jsx)(ThemeProvider, { children: (0, import_jsx_runtime3.jsxs)(FeatureFlagProvider, { children: [
...
var InfiniteList = ({
  ...
  (0, import_react23.useEffect)(() => {
    ...
    if (!isFetching) {
      ...
      endObserver.current = new IntersectionObserver(
        (entries) => {
          ...
          if (entries[0].isIntersecting && hasNextPage) {
            (_a3 = endObserver.current) == null ? void 0 : _a3.disconnect();
            fetchNextPage();
          }
        },
        {
      ...
      if ((_a2 = parentRef.current) == null ? void 0 : _a2.firstChild) {
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-list-IFPXJREP-5R4J4YOI.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-Q5ZIYMOR-BDTBWSIE.js")
                    },
                    {
                      path: "import",
                      lazy: () => import("./product-import-QMH7G2E3-N53DMY3K.js")
                    },
                    {
                      path: "export",
                      lazy: () => import("./product-export-6CVNHDLC-LN6MWMIS.js")
                    }
                  ]
                },
                {
                  ...
                  errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-YMCONFSY-7UIZXPMY.js");
                    return {
                      Component: Outlet,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-YMCONFSY-7UIZXPMY.js"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-SRWVIV2Z-SBKW6TB5.js")
                        },
                        {
                          path: "edit-variant",
                          lazy: () => import("./product-variant-edit-KHBGDI3A-VVKOMKCT.js")
                        },
                        {
                          path: "sales-channels",
                          lazy: () => import("./product-sales-channels-UEHJPFY4-YW6N2Y2N.js")
                        },
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-HQ2HQQSE-74VALQWE.js")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-PKNCLB6W-AJON6WDQ.js")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-266AXOO6-5NACLWPR.js")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-F74IPY26-OOJPEVZ3.js")
                        },
                        {
                          path: "prices",
                          lazy: () => import("./product-prices-TWFFDJMF-HY5U543Z.js")
                        },
                        {
                          path: "options/create",
                          lazy: () => import("./product-create-option-3JR35UZ5-WMLLW3DK.js")
                        },
                        {
                          path: "options/:option_id/edit",
                          lazy: () => import("./product-edit-option-VNDGZ37A-CTX6SU7O.js")
                        },
                        {
                          path: "variants/create",
                          lazy: () => import("./product-create-variant-ZWPXKWXM-GZMMIEUJ.js")
                        },
                        {
                          path: "stock",
                          lazy: () => import("./product-stock-GPN7ZE22-3JH7G2YT.js")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-metadata-W7FXF7QQ-CFCIJWDW.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./product-variant-detail-TPNU66G2-NWEHSC2Z.js");
                        return {
                      ...
                      children: [
                        ...
                        {
                          path: "manage-items",
                          lazy: () => import("./product-variant-manage-inventory-items-TM3VAHBJ-NRVGAZHU.js")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-variant-metadata-DWQUPNWT-L45MYNC7.js")
                        }
                      ]
                    }
                  ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./category-list-UI6W5KF5-LFKBHNYQ.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./category-create-FOVB5MJ4-FLF5VP7R.js")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-BW3YOPUS-LDJPJCW7.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./category-detail-4QR47JKY-3FAEZVRK.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./category-edit-O4ZSANE5-ZRZD2452.js")
                    },
                    {
                      path: "products",
                      lazy: () => import("./category-products-YUY32KK7-YNIFKRLF.js")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-BW3YOPUS-LDJPJCW7.js")
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./categories-metadata-WRYMQSDD-BGK7U4FS.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./order-list-S44VQXUW-LEAVCN4R.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./order-detail-BDX6VUSZ-5KYND6HX.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "fulfillment",
                      lazy: () => import("./order-create-fulfillment-GHPTFG4B-B6NL25W4.js")
                    },
                    {
                      path: "returns/:return_id/receive",
                      lazy: () => import("./order-receive-return-GHFXXERW-7C6XND4E.js")
                    },
                    {
                      path: "allocate-items",
                      lazy: () => import("./order-allocate-items-J3ZHGC22-MX2D3GI7.js")
                    },
                    {
                      path: ":f_id/create-shipment",
                      lazy: () => import("./order-create-shipment-ONBT3ZAD-ZE5F6K3N.js")
                    },
                    {
                      path: "returns",
                      lazy: () => import("./order-create-return-IIEBZOZZ-EST4BQ3R.js")
                    },
                    {
                      path: "claims",
                      lazy: () => import("./order-create-claim-DBL2BU5Q-IUX77744.js")
                    },
                    {
                      path: "exchanges",
                      lazy: () => import("./order-create-exchange-6E2VLPU3-CSNZHVVZ.js")
                    },
                    {
                      path: "edits",
                      lazy: () => import("./order-create-edit-INKNOFBY-2RETC5F6.js")
                    },
                    {
                      path: "refund",
                      lazy: () => import("./order-create-refund-HJMKDY6S-GHEXURZ4.js")
                    },
                    {
                      path: "transfer",
                      lazy: () => import("./order-request-transfer-NJ24WZ26-SKMT2HKO.js")
                    },
                    {
                      path: "email",
                      lazy: () => import("./order-edit-email-FSHV32T6-H4FX3UHR.js")
                    },
                    {
                      path: "shipping-address",
                      lazy: () => import("./order-edit-shipping-address-RV2QZCR5-TZYS7X6Q.js")
                    },
                    {
                      path: "billing-address",
                      lazy: () => import("./order-edit-billing-address-K2SUQK3S-G4JS7WCZ.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./order-metadata-5K76LVXK-EOBQLKAH.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-R7J2AWA3-IJF6OUY3.js")
                },
                {
                  path: "create",
                  lazy: () => import("./promotion-create-B5T3Y7E2-OZY66HS5.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./promotion-detail-X5XWYLTC-WFHNSMZB.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./promotion-edit-details-C5ZET6NQ-FT42XIRZ.js")
                    },
                    {
                      path: "add-to-campaign",
                      lazy: () => import("./promotion-add-campaign-SWDK2V4H-NXK3HKNL.js")
                    },
                    {
                      path: ":ruleType/edit",
                      lazy: () => import("./edit-rules-XXGPR2FT-536XIM3D.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./campaign-list-4SDTXM7M-QBZ2H26F.js"),
                  children: []
                },
                {
                  path: "create",
                  lazy: () => import("./campaign-create-PIJCSZ5O-UFNE7FKC.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./campaign-detail-FIO6336E-XIUPCIPX.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./campaign-edit-3TDW52BO-A2P46QLZ.js")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./campaign-configuration-Z5HA2DG3-PZ75DSZX.js")
                    },
                    {
                      path: "edit-budget",
                      lazy: () => import("./campaign-budget-edit-GJ5CTZ7O-GKET6SGO.js")
                    },
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-UQVBTTWK-IPKPOXCE.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./collection-list-CLPNXVMS-L5V4HBHL.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./collection-create-75ZI5NDG-FN3UHVVH.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./collection-detail-ZPCU3EEN-6T36WYA5.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./collection-edit-RD6BDDDI-ZQHNDHVM.js")
                    },
                    {
                      path: "products",
                      lazy: () => import("./collection-add-products-PRJPIHVN-Y6ALCX3C.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./collection-metadata-K5AEUTPO-G65MS3HU.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./price-list-list-C6NEB2R4-3AJAGCFV.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./price-list-create-RRCY4W23-TQ7FIQ5R.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./price-list-detail-YZSZWUP2-DJ23QP7O.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./price-list-edit-ZGBOZYSC-LUCORUZH.js")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./price-list-configuration-435QDWB2-IR363PN4.js")
                    },
                    {
                      path: "products/add",
                      lazy: () => import("./price-list-prices-add-ETIVPBFT-VYS7VXX7.js")
                    },
                    {
                      path: "products/edit",
                      lazy: () => import("./price-list-prices-edit-CEBPQPOW-UD4ETPMC.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-list-SINCBCOZ-T4F5A4JE.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-create-BIM4YFGV-6PS7LRYE.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./customer-detail-NLXTCFPZ-NKLM36W7.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-edit-FJNPYFCK-JHKAMPJ3.js")
                    },
                    {
                      path: "create-address",
                      lazy: () => import("./customer-create-address-TPSDYZBN-RWPOCZYO.js")
                    },
                    {
                      path: "add-customer-groups",
                      lazy: () => import("./customers-add-customer-group-54XAF37I-LKDASAW5.js")
                    },
                    {
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-metadata-5NPUMPZ2-ZL4BLB6I.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-group-list-SAPKHZKC-4BFB756V.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-group-create-7X4TZR54-E2BO3SQV.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./customer-group-detail-QH5GRVW4-3J57MHVX.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-group-edit-J3AGQAAF-XKPID52X.js")
                    },
                    {
                      path: "add-customers",
                      lazy: () => import("./customer-group-add-customers-L6C6YCYR-QKFKFMNI.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-group-metadata-UPAPULMF-5QCBAKQD.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./reservation-list-UOC7RNRZ-BQNNU3CS.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./reservation-create-7RFXWDXB-E47WBJAW.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./reservation-detail-R6ESLSMI-CF5JA2NH.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-reservation-EKH4RIAX-OFKKNASV.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./reservation-metadata-YL4JMCQE-3FMS7GEF.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./inventory-list-YMYF7QVP-XYMQTITS.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./inventory-create-NSKQEHK2-BHPMDK6P.js")
                    },
                    {
                      path: "stock",
                      lazy: () => import("./inventory-stock-UVRZKF5X-G3NM5BXN.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./inventory-detail-ELEYNJFN-5ZLQ3KAY.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-inventory-item-ZPE4MMC4-75JVPTXP.js")
                    },
                    {
                      path: "attributes",
                      lazy: () => import("./edit-inventory-item-attributes-KT7BSPZ7-D7AV2D2U.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./inventory-metadata-2HVT3EKE-ZT6W464P.js")
                    },
                    {
                      path: "locations",
                      lazy: () => import("./manage-locations-3TBIUSHP-6DSYWYYH.js")
                    },
                    {
                      path: "locations/:location_id",
                      lazy: () => import("./adjust-inventory-WBEBMJN7-YXANYBQY.js")
                    }
                  ]
                }
              ]
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              path: "profile",
              errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
              lazy: () => import("./profile-detail-ROG22HHL-ECNIX4NL.js"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./profile-edit-HSUQIQQH-W5V3ZGTN.js")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./region-list-LNEYDZO7-FH2TZKLO.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./region-create-ZAA4ZS4V-QL44R2GA.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./region-detail-4VYOX6M2-W22VIPQF.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./region-edit-73KFG3VK-JUXZBAKX.js")
                    },
                    {
                      path: "countries/add",
                      lazy: () => import("./region-add-countries-Y4YAHDUZ-E6HKSM64.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./region-metadata-3RZXPZYC-JSYAE76K.js")
                    }
                  ]
                }
              ]
            },
            {
              path: "store",
              errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
              lazy: () => import("./store-detail-4TPJFT3B-H6WCTL5H.js"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./store-edit-EU55TNFU-IJARKJFG.js")
                },
                {
                  path: "currencies",
                  lazy: () => import("./store-add-currencies-R26SVHT5-JPPOS53Z.js")
                },
                {
                  path: "metadata/edit",
                  lazy: () => import("./store-metadata-AGSIUGUM-QQE2H3WA.js")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./user-list-UFAGC74E-3TKZA63R.js"),
                  children: [
                    {
                      path: "invite",
                      lazy: () => import("./user-invite-W26LOOW7-2HFTFT3I.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./user-detail-VIVFFLOW-THB5726R.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./user-edit-XTVRRK7B-6VR4LFYR.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./user-metadata-TSZERV4Z-JEOCQSX4.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./sales-channel-list-CYH5F4NC-4BY6MM2J.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./sales-channel-create-3MPOMVPD-B6D5YUOZ.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./sales-channel-detail-CBWJPVRJ-QDFG7A5K.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./sales-channel-edit-LSLAM7A4-CMBUDABE.js")
                    },
                    {
                      path: "add-products",
                      lazy: () => import("./sales-channel-add-products-SJPDHMLE-I4I45ZPM.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./sales-channel-metadata-RFGMTL67-T6P6M2WK.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./location-list-QSWVHH2R-T4T5SNEI.js")
                },
                {
                  path: "create",
                  lazy: () => import("./location-create-LUP363ZB-7RXI7QIL.js")
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./shipping-profiles-list-ZHJEUIKJ-GVSENGTD.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./shipping-profile-create-KRMI6NUI-2BQGJGCK.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./shipping-profile-detail-FDUPDSH4-LPAU66LX.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
                      ...
                      children: [
                        {
                          path: "metadata/edit",
                          lazy: () => import("./shipping-profile-metadata-HOAV5TMT-2FGM2BGB.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./shipping-option-type-list-ZAUAZ4SY-DZ6SUAL4.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./shipping-option-type-create-IZ5GJVEB-3RATDN6L.js")
                        }
                      ]
                    },
                    {
                      path: ":id",
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./shipping-option-type-detail-RVDWBSYL-ROUBZDN2.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
                      ...
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./shipping-option-type-edit-CVGB6QN7-RET6IUQ2.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":location_id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./location-detail-RRA5BQRU-GMPWCETY.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./location-edit-26K26G23-LN6CUXTS.js")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./location-sales-channels-7TP5PBQ2-A4HUDWA2.js")
                    },
                    {
                      path: "fulfillment-providers",
                      lazy: () => import("./location-fulfillment-providers-OUZYY6QB-XISWP2LZ.js")
                    },
                    {
                      ...
                      children: [
                        {
                          ...
                          lazy: () => import("./location-service-zone-create-RPFLBVV4-CLPW75JR.js")
                        },
                        {
                          ...
                          children: [
                            {
                              path: "edit",
                              lazy: () => import("./location-service-zone-edit-74Q2BX26-WIVK7W7S.js")
                            },
                            {
                              path: "areas",
                              lazy: () => import("./location-service-zone-manage-areas-VEUUGPKF-BTVYTVSC.js")
                            },
                            {
                              ...
                              children: [
                                {
                                  path: "create",
                                  lazy: () => import("./location-service-zone-shipping-option-create-XCFHGQFQ-NYML3BUA.js")
                                },
                                {
                                  path: ":so_id",
                                  children: [
                                    {
                                      path: "edit",
                                      lazy: () => import("./location-service-zone-shipping-option-edit-TMXNX4VX-IYQ7UTN7.js")
                                    },
                                    {
                                      path: "pricing",
                                      lazy: () => import("./location-service-zone-shipping-option-pricing-5BAXQBBI-5JD6PJFG.js")
                                    }
                                  ]
                                }
                              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-tag-list-Y5VDA4UN-AZSPU4H4.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-tag-create-CACJ2SAP-ZXM255F2.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./product-tag-detail-P2HDD46P-7LUXG5ND.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-tag-edit-2QUHLDDN-54I5AHZR.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./product-tag-metadata-ETEYC2MT-DFAUVWV3.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./workflow-execution-list-5J3DQQRD-P7C2IEBC.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./workflow-execution-detail-DLD47TRZ-73AOMNUS.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-type-list-IL3SBQDF-B2OZVIED.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-type-create-VXEOY6IV-FXIRN7A5.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./product-type-detail-ZXMLT3JV-76TNLOV5.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-type-edit-EOBA5GJ3-J3FCVGC6.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./product-type-metadata-FON74JVV-P5FMVY3R.js")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./api-key-management-list-VUJA6XGI-UARAWVYW.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./api-key-management-create-VXPZX2Q5-KTIQOZWB.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./api-key-management-detail-PURKM2FS-Q2VXHNQ5.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./api-key-management-edit-7CGMSHAY-V72YMTM3.js")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./api-key-management-sales-channels-ZSAQFICH-FLD67EEH.js")
                    }
                  ]
                }
              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./tax-region-list-3BGD6Z6N-WH4E735N.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-VO65RBTI-NBPF47JE.js")
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: async () => {
                        const { Component: Component4 } = await import("./tax-region-detail-6PIW5QJY-ZDZHFNYR.js");
                        return {
                          Component: Component4
                        };
                      },
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./tax-region-edit-7ARMCDN5-EBN542SV.js")
                        },
                        {
                          path: "provinces/create",
                          lazy: () => import("./tax-region-province-create-ZQ7QGVE4-PBG2CJU5.js")
                        },
                        {
                          path: "overrides/create",
                          lazy: () => import("./tax-region-tax-override-create-RROYEQWD-76KCRCE6.js")
                        },
                        {
                          path: "overrides/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-override-edit-2QD327MZ-YDW4KAA5.js")
                        },
                        {
                          path: "tax-rates/create",
                          lazy: () => import("./tax-region-tax-rate-create-T2FKYRNI-ZXAECJYA.js")
                        },
                        {
                          path: "tax-rates/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-rate-edit-VACYUP6R-5OQ2ORUM.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./tax-region-province-detail-RC6KMZ6X-XFQ3IGWM.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./return-reason-list-4EKZE3DJ-JDLMI43U.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./return-reason-create-TFLUQVJH-4R2V2LLS.js")
                    },
                    {
                      path: ":id",
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./return-reason-edit-WN3KGPRR-4IND47ML.js")
                        }
                      ]
                    }
                  ]
      ...
      children: [
        {
          ...
          children: [
            {
              path: "/login",
              lazy: () => import("./login-4TGFHBMF-MCIF3FMG.js")
            },
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-OIRVPF4I-K2XOLVOX.js")
            },
            {
              path: "/invite",
              lazy: () => import("./invite-IQITJV62-RDEZ3ICY.js")
            },
            {
              path: "*",
              lazy: () => import("./no-match-KSAPNRPO-GY44YUSZ.js")
            }
          ]
        }
      ]
...
function createExtendedSchema(baseSchema, additionalDataSchema) {
  const extendedObjectSchema = external_exports.object({
    ...baseSchema instanceof ZodEffects ? baseSchema.innerType().shape : baseSchema.shape,
    additional_data: external_exports.object(additionalDataSchema).optional()
  });
...
//# sourceMappingURL=chunk-CPONUCWC.js.map
